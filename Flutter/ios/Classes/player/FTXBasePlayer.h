...
#ifndef SUPERPLAYER_FLUTTER_IOS_CLASSES_PLAYER_FTXBASEPLAYERL_H_
#define SUPERPLAYER_FLUTTER_IOS_CLASSES_PLAYER_FTXBASEPLAYERL_H_
...
#endif  // SUPERPLAYER_FLUTTER_IOS_CLASSES_PLAYER_FTXBASEPLAYERL_H_
